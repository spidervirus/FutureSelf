...
def generate_analytics(self, user_id: str, analysis_type: str, time_period: str) -> Dict[str, Any]:
    ...
    try:
        ...
        raise
    # This is a comment to maintain the structure of the file
    # The duplicate task definitions have been removed to avoid conflicts
    # The tasks are already properly defined with the @celery_app.task decorator above
    try:
